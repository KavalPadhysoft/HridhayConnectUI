...
const Invoice = () => {
  ...
  const isFormPage = location.pathname.startsWith("/Invoices/manage");
            ...
            <Card>
              <CardBody>
                <div className="d-flex justify-content-end mb-3">
                  <Button color="primary" type="button" onClick={() => navigate("/Invoices/manage")}> 
